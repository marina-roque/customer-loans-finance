...
class DataHandler:
    def __init__(self, data):
        self.data = data
        self.original_data = data.copy()  # Create a central copy
...
class DataFrameTransform:
    ...
    def drop_rows_and_impute(self):
        ...
        # Impute columns with 1% to 10% null values
...
if __name__ == "__main__":
    ...
    frame_transformer.drop_columns_with_missing_values(threshold=0.4) #why is this not dropping now if it was working before???
   ...
   #For DataFraneInfo
    ...
    plotter.create_boxplot(data_handler.get_modified_data(), columns_of_interest_1, title="Box Plots with Outliers 1")
    df_outliers_handled_1 = frame_transformer.handle_outliers_iqr(data_handler, columns_of_interest_1)
    plotter.create_boxplot(df_outliers_handled_1, columns_of_interest_1, title="Box Plots with Outliers Handled 1 (IQR)")
        
    columns_of_interest_2 = ['loan_amount', 'out_prncp', 'total_payment']
    plotter.create_boxplot(data_handler.get_modified_data(), columns_of_interest_2, title="Box Plots with Outliers 2")
    df_outliers_handled_2 = frame_transformer.handle_outliers_iqr(data_handler, columns_of_interest_2)
    plotter.create_boxplot(df_outliers_handled_2, columns_of_interest_2, title="Box Plots with Outliers Handled 1 (IQR)")

    columns_of_interest_3 = ['annual_inc']
    plotter.create_boxplot(data_handler.get_modified_data(), columns_of_interest_3, title="Box Plots with Outliers 3")
    df_outliers_handled_3 = frame_transformer.handle_outliers_iqr(data_handler, columns_of_interest_3)
    plotter.create_boxplot(df_outliers_handled_3, columns_of_interest_3, title="Box Plots with Outliers Handled 1 (IQR)")
